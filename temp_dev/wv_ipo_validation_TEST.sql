-- =============================================================================
-- IP&O Validation Detail View - Single Period Test Query
-- =============================================================================
-- Purpose: Focused validation for August 2025 only
-- Use Case: Quick validation checks and ad-hoc analysis for specific month
-- 
-- SCHEMA DESIGN:
-- - snake_case column naming for Power BI compatibility
-- - Single period filtering (August 2025)
...
WHERE Period = '2025-08-31'  -- Filter for August 2025 only
ORDER BY company_code, location_name, product_code;
